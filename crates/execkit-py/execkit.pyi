...
class Session:
    ...
    def exec(
        ...
        *,
        ...
        command that cannot be interrupted raises :class:`Timeout` (and poisons
        the session). The budget kwargs ``tail``, ``head``, ``grep`` and
        ``max_chars`` shape this call's output and override the session default.
        """
    @property
...
class Timeout(SessionUnusable):
    """A timed-out command could not be interrupted; the session is poisoned."""
